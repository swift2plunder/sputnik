...
NODE.html_body      = [[
  <!--[if lt IE 7]><p class=oldie>Your browser is <em>ancient!</em> <a href="http://outdatedbrowser.com/">Upgrade to a different browser</a> to experience this site.</p><![endif]-->
